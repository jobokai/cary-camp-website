...
export default function Layout({ children, title, description }) {
  ...
  return (
    <div className="page-wrapper">
      ...
      <header className="header" role="banner">
        <div className="container">
          ...
          <nav className="nav" role="navigation" aria-label="Main navigation">
            ...
            <a
              href="https://campreservation.com/162/Camps/781"
              className="nav__cta"
            >
              Book Your Visit
            </a>
          ...
          <div className="mobile-nav">
            ...
            <div id="mobile-menu" className={`mobile-nav__menu ${navOpen ? 'mobile-nav__menu--open' : ''}`}>
              ...
              <Link
                to="/facilities"
                className={`mobile-nav__link ${isActive('/facilities') ? 'mobile-nav__link--active' : ''}`}
                onClick={() => setNavOpen(false)}
              >
                What We Offer
              </Link>
              ...
              <Link
                to="/trading-post"
                className={`mobile-nav__link ${isActive('/trading-post') ? 'mobile-nav__link--active' : ''}`}
                onClick={() => setNavOpen(false)}
              >
                Trading Post
              </Link>
      ...
      <footer className="footer texture-tree-rings texture-bg texture-bg-overlay--dark-blue" role="contentinfo">
        <div className="container">
        ...
        <div className="footer__bottom">
          <div className="container">
            ...
            <p>Made with <FontAwesomeIcon icon={faHeart} className="footer__bottom--icon" /> by <a href="mailto:rob@graphicflow.net">Rob</a></p>
          </div>
        </div>
      </footer>
    </div>
